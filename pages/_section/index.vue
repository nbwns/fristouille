<template>
  <section class="flex flex-col justify-center items-center layer__xl mx-auto">
	<spacer size="xxs"></spacer>
			<!-- body  -->
			<div class="flex flex-col-reverse md:flex-row-reverse justify-start md:justify-between items-center w-full gap-5">
						<!--  page title -->
				<div class="w-1/2 flex-1">
						<div class="w-56 hidden md:flex md:absolute top-24 lg:top-40 left-1/2">
				...
				<div class="text-left w-full lg:w-fit py-10 lg:py-20">
