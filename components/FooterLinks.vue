        ...
        <div class="flex flex-col sm:flex-row sm:justify-between w-full ">
          ...
          <div class="flex flex-col justify-end  w-full">
            <div class="flex flex-row justify-end items-center gap-3 text-orange-200
              ...
              <svg v-if="dark" width="59" height="67" viewBox="0 0 59 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="29" cy="33" r="22" fill="currentColor"/>
                <path d="M35 28C35 29.64 36.1 31 37.5 31C38.9 31 40 29.68 40 28C40 26.36 38.9 25 37.5 25C36.1 25 35 26.36 35 28Z" fill="#1D1D1B"/>
                <path d="M22 31C20.8954 31 20 29.6569 20 28C20 26.3431 20.8954 25 22 25C23.1046 25 24 26.3431 24 28C24 29.6569 23.1046 31 22 31Z" fill="#1D1D1B"/>
                <path d="M29.2491 44C31.2947 44 33.3404 43.413 35 42.2391L33.7649 41C31.2947 42.7283 27.7053 42.8261 25.1579 41.2283L24 42.5326C25.5439 43.5109 27.3965 44 29.2491 44Z" fill="#1D1D1B"/>
                </svg>
              <svg v-else width="59" height="67" viewBox="0 0 59 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="29" cy="33" r="22" fill="currentColor"/>
                <path d="M35 28C35 29.64 36.1 31 37.5 31C38.9 31 40 29.68 40 28C40 26.36 38.9 25 37.5 25C36.1 25 35 26.36 35 28Z" fill="#1D1D1B"/>
                <path d="M22 31C20.8954 31 20 29.6569 20 28C20 26.3431 20.8954 25 22 25C23.1046 25 24 26.3431 24 28C24 29.6569 23.1046 31 22 31Z" fill="#1D1D1B"/>
                <path d="M29.2491 44C31.2947 44 33.3404 43.413 35 42.2391L33.7649 41C31.2947 42.7283 27.7053 42.8261 25.1579 41.2283L24 42.5326C25.5439 43.5109 27.3965 44 29.2491 44Z" fill="#1D1D1B"/>
                </svg>
              <a href="#" class="font-labil font-semibold !text-xl text-white-200 dark:text-black-200 uppercase hover:underline">faq</a>
            </div>
