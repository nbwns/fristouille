		...
		<div class="hidden md:flex mx-10 md:mx-0 mb-10">
			<div class="flex flex-col layer__xl space-y-[63px]  items-center mx-auto justify-center">
				...
				<div class="wrap-sublink">
					<div>
						<ul>
							<li><a href="https://forms.fillout.com/t/tAiagUtQpwus" target="_blank" class="navlink">Ajouter une
									recette</a></li>
							<li><nuxt-link class="navlink" to="/recettes-categories" exact no-prefetch>Recettes par
									catégories</nuxt-link></li>
						</ul>
					</div>
					<div>
						<ul>
							<li><nuxt-link class="navlink" to="/a-propos" no-prefetch exact>À propos</nuxt-link></li>
							<li><a href="https://fristouille.super.site/" target="_blank" class="navlink">Services pour
									entreprises</a></li>
						</ul>
					</div>
					<div>
						<ul>
							<li><nuxt-link class="navlink" to="/a-propos/mentions-legales" no-prefetch exact>Mentions
									légales</nuxt-link></li>
							<li><nuxt-link class="navlink" to="/a-propos/accessibilite" no-prefetch exact>Déclaration
									d'accessibilité</nuxt-link></li>
						</ul>
					</div>
				...
				<div class="w-full sm:w-1/3">
					...
					<div class="flex justify-center">
						<div class="flex flex-row justify-around w-6/12 items-center">
							<!-- e-mail -->
							<a href="mailto:bonjour@fristouille.org">
								<svg class="fill-orange-200 dark:fill-purple-200" width="29" height="30" viewBox="0 0 29 30"
							...
							<!-- instagram -->
							<svg class="fill-orange-200 dark:fill-purple-200" width="30" height="30" viewBox="0 0 30 30"
								xmlns="http://www.w3.org/2000/svg">
								<path
							...
							<!-- facebook -->
							<a href="https://www.facebook.com/fristouille.org" target="_blank">
								<svg class="fill-orange-200 dark:fill-purple-200" width="29" height="30" viewBox="0 0 29 30"
									xmlns="http://www.w3.org/2000/svg">
									<path
				...
				<!-- newsletter + toggle + ecoindex -->
				<div class="flex flex-col sm:flex-row sm:justify-between w-full ">
					<div class="flex flex-col space-y-4 w-full">
						<h4 class="leading-none">Inscrivez-vous à notre newsletter</h4>
               ...
               dark:text-purple-200 ">
							<div>
								...
								<a href="https://bff.ecoindex.fr/redirect/?url=https://fristouille.netlify.app" target="_blank">
									<img src="https://bff.ecoindex.fr/badge/?theme=dark&url=https://fristouille.netlify.app"
										alt="Ecoindex Badge" />
								</a>
							</div>
							<dark-mode-toggle />
...
export default {
	components: { DarkModeToggle, NavLink },
	computed: {
		currentYear() {
