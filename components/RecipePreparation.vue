<template>
  <div class="flex flex-col">
    ...
    <div v-html="procedure"
      class="prose-fristouille font-light text-balance prose-ol:text-base prose-ol:leading-tight prose-ol:font-light prose-ol:ligatures-none prose-li:mb-6 prose-p:text-base  prose-p:text-foreground prose-p:font-sans prose-ol:text-foreground prose-ul:text-foreground prose-li:text-foreground prose-a:text-accent prose-a:hover:text-foreground prose-a:focus:text-foreground" />
