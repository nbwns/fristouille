	...
	<section class="flex w-full items-center mx-auto justify-center py-10">
		<div class="w-full flex flex-col space-y-3">
			...
			<div
				...
				<nuxt-link :to="article.url" class="flex flex-col md:flex-row justify-start w-full h-full">
					<!-- Image on the left -->
