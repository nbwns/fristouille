...
<style>
.drawer {
	position: fixed; /* STEPH: j'ai fait ça pour pas qu'il disparaisse quand on scrolle vers le bas, ou alors il faudrait bloquer le scroll sur le body ? */
	bottom: 0;
	left: 0;
	width: 100vw;
	height: 0; /* initially */
	overflow: hidden;
	padding-top: 0; /* initially */
	z-index: 200;
