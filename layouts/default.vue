<template>
  <div class="grid min-h-screen  bg-reglisse-100">
	...
	<footer>
    <div class="flex mx-10 md:mx-0 mb-10 ">
      <div class="flex flex-col w-full md:w-9/12 lg:w-7/12 space-y-[63px]  items-center mx-auto justify-center">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between w-full ">
          <div class="flex flex-col w-full">
            <h4>Suscribe to our newslettter</h4>
          ...
          <div class="flex flex-col justify-end  w-full">
            <div class="flex flex-row justify-end items-center gap-3">
              <svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="20" cy="20.7021" r="20" fill="#FF9877" />
                <path
                  d="M14 19.7021C12.8954 19.7021 12 18.8067 12 17.7021C12 16.5976 12.8954 15.7021 14 15.7021C15.1046 15.7021 16 16.5976 16 17.7021C16 18.8067 15.1046 19.7021 14 19.7021Z"
                  fill="#1D1D1B" />
                <path
                  d="M27 19.7021C25.8954 19.7021 25 18.8067 25 17.7021C25 16.5976 25.8954 15.7021 27 15.7021C28.1046 15.7021 29 16.5976 29 17.7021C29 18.8067 28.1046 19.7021 27 19.7021Z"
                  fill="#1D1D1B" />
                <path
                  d="M20.2491 29.7021C22.2947 29.7021 24.3404 29.1152 26 27.9413L24.7649 26.7021C22.2947 28.4304 18.7053 28.5282 16.1579 26.9304L15 28.2348C16.5439 29.213 18.3965 29.7021 20.2491 29.7021Z"
                  fill="#1D1D1B" />
              </svg>
              <a href="#" class="font-labil font-semibold !text-xl text-white-200 uppercase hover:underline">faq</a>
            </div>
            <p class="note text-right">copyright ©fristouille 2022</p>
          </div>
        </div>
      </div>
    </div>
